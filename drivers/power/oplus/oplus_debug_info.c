...
static struct oplus_chg_debug_notify_policy oplus_chg_debug_notify_policy[] = {
	...
	[OPLUS_NOTIFY_CHG_UNSUSPEND]                    = {OPLUS_CHG_NOTIFY_ONCE,        1,    1,      -1},
	...
	[OPLUS_NOTIFY_CHG_ASIC_ERR]             			 = {OPLUS_CHG_NOTIFY_REPEAT,          1,    1,      -1},
};
...
static void oplus_chg_send_info_dwork(struct work_struct *work)
{
	...
	if ((ret > 0) && (oplus_chg_debug_info.retry_cnt > 0)) {
		...
		oplus_chg_debug_mask_notify_flag(OPLUS_NOTIFY_CHG_ASIC_ERR, OPLUS_NOTIFY_CHG_ASIC_ERR);
...
int oplus_chg_asic_err(void)
{
	if (!oplus_chg_debug_notify_flag_is_set(OPLUS_NOTIFY_CHG_ASIC_ERR)) {
		oplus_chg_set_notify_type(OPLUS_CHG_DEBUG_NOTIFY_TYPE_ASIC_ERR);
		oplus_chg_set_chg_flag(OPLUS_NOTIFY_CHG_ASIC_ERR);
	}
	return 0;
}
