...
int mp2650_usbin_input_current_limit[] = {
	500, 900, 1200, 1500, 1700, 2000, 3000,
};
...
int mp2650_input_current_limit_write(int current_ma)
{
	...
	/* setting 3A, increase step by step */
	i = 7;
	chg_vol = mp2650_get_charger_vol();
	rc = mp2650_config_interface(REG00_MP2650_ADDRESS, REG00_MP2650_1ST_CURRENT_LIMIT_2100MA, REG00_MP2650_1ST_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG0F_MP2650_ADDRESS, REG00_MP2650_1ST_CURRENT_LIMIT_2100MA, REG0F_MP2650_2ND_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = mp2650_get_charger_vol();
	if (chg_vol < sw_aicl_point) {
		i = i - 2; /* 2 */
	...
	rc = mp2650_config_interface(REG00_MP2650_ADDRESS, REG00_MP2650_1ST_CURRENT_LIMIT_2700MA, REG00_MP2650_1ST_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG0F_MP2650_ADDRESS, REG00_MP2650_1ST_CURRENT_LIMIT_2700MA, REG0F_MP2650_2ND_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = mp2650_get_charger_vol();
	if (chg_vol < sw_aicl_point) {
		i = i - 2; /* 2 */
...
bool mp2650_check_suspend_charger(void)
{
	...
	chg_err("data = %d\n", data & REG08_MP2650_LEARN_EN_MASK);
